...
static int
_sqlite3_3_26_open_v2(const char *filename, sqlite3 **ppDb, int flags, const char *zVfs) {
#ifdef SQLITE_OPEN_URI
  return sqlite3_3_26_open_v2(filename, ppDb, flags | SQLITE_OPEN_URI, zVfs);
#else
  return sqlite3_3_26_open_v2(filename, ppDb, flags, zVfs);
#endif
}

static int
_sqlite3_3_26_bind_text(sqlite3_3_26_stmt *stmt, int n, char *p, int np) {
  return sqlite3_3_26_bind_text(stmt, n, p, np, SQLITE_TRANSIENT);
}

static int
_sqlite3_3_26_bind_blob(sqlite3_3_26_stmt *stmt, int n, void *p, int np) {
  return sqlite3_3_26_bind_blob(stmt, n, p, np, SQLITE_TRANSIENT);
}
...
static int
_sqlite3_3_26_exec(sqlite3* db, const char* pcmd, long long* rowid, long long* changes)
{
  int rv = sqlite3_3_26_exec(db, pcmd, 0, 0, 0);
  *rowid = (long long) sqlite3_3_26_last_insert_rowid(db);
  *changes = (long long) sqlite3_3_26_changes(db);
  return rv;
}

#ifdef SQLITE_ENABLE_UNLOCK_NOTIFY
extern int _sqlite3_3_26_step_blocking(sqlite3_3_26_stmt *stmt);
extern int _sqlite3_3_26_step_row_blocking(sqlite3_3_26_stmt* stmt, long long* rowid, long long* changes);
extern int _sqlite3_3_26_prepare_v2_blocking(sqlite3 *db, const char *zSql, int nBytes, sqlite3_3_26_stmt **ppStmt, const char **pzTail);

static int
_sqlite3_3_26_step_internal(sqlite3_3_26_stmt *stmt)
{
  return _sqlite3_3_26_step_blocking(stmt);
}

static int
_sqlite3_3_26_step_row_internal(sqlite3_3_26_stmt* stmt, long long* rowid, long long* changes)
{
  return _sqlite3_3_26_step_row_blocking(stmt, rowid, changes);
}

static int
_sqlite3_3_26_prepare_v2_internal(sqlite3 *db, const char *zSql, int nBytes, sqlite3_3_26_stmt **ppStmt, const char **pzTail)
{
  return _sqlite3_3_26_prepare_v2_blocking(db, zSql, nBytes, ppStmt, pzTail);
}
...
_sqlite3_3_26_step_internal(sqlite3_3_26_stmt *stmt)
{
  return sqlite3_3_26_step(stmt);
}

static int
_sqlite3_3_26_step_row_internal(sqlite3_3_26_stmt* stmt, long long* rowid, long long* changes)
{
  int rv = sqlite3_3_26_step(stmt);
  sqlite3* db = sqlite3_3_26_db_handle(stmt);
  *rowid = (long long) sqlite3_3_26_last_insert_rowid(db);
  *changes = (long long) sqlite3_3_26_changes(db);
  return rv;
}
...
_sqlite3_3_26_prepare_v2_internal(sqlite3 *db, const char *zSql, int nBytes, sqlite3_3_26_stmt **ppStmt, const char **pzTail)
{
  return sqlite3_3_26_prepare_v2(db, zSql, nBytes, ppStmt, pzTail);
}
#endif

void _sqlite3_3_26_result_text(sqlite3_3_26_context* ctx, const char* s) {
  sqlite3_3_26_result_text(ctx, s, -1, &free);
}

void _sqlite3_3_26_result_blob(sqlite3_3_26_context* ctx, const void* b, int l) {
  sqlite3_3_26_result_blob(ctx, b, l, SQLITE_TRANSIENT);
}


int _sqlite3_3_26_create_function(
  sqlite3 *db,
  ...
  return sqlite3_3_26_create_function(db, zFunctionName, nArg, eTextRep, (void*) pApp, xFunc, xStep, xFinal);
}

void callbackTrampoline_new(sqlite3_3_26_context*, int, sqlite3_3_26_value**);
void stepTrampoline_new(sqlite3_3_26_context*, int, sqlite3_3_26_value**);
void doneTrampoline_new(sqlite3_3_26_context*);

int compareTrampoline_new(void*, int, char*, int, char*);
int commitHookTrampoline_new(void*);
void rollbackHookTrampoline_new(void*);
void updateHookTrampoline_new(void*, int, char*, char*, sqlite3_3_26_int64);

int authorizerTrampoline_new(void*, int, char*, char*, char*, char*);
...
static int _sqlite3_3_26_limit(sqlite3* db, int limitId, int newLimit) {
#ifndef _SQLITE_HAS_LIMIT
  return -1;
#else
  return sqlite3_3_26_limit(db, limitId, newLimit);
#endif
}
...
func Version() (libVersion string, libVersionNumber int, sourceID string) {
	libVersion = C.GoString(C.sqlite3_3_26_libversion())
	libVersionNumber = int(C.sqlite3_3_26_libversion_number())
	sourceID = C.GoString(C.sqlite3_3_26_sourceid())
...
func (fi *functionInfo) Call(ctx *C.sqlite3_3_26_context, argv []*C.sqlite3_3_26_value) {
...
func (ai *aggInfo) agg(ctx *C.sqlite3_3_26_context) (int64, reflect.Value, error) {
	aggIdx := (*int64)(C.sqlite3_3_26_aggregate_context(ctx, C.int(8)))
	if *aggIdx == 0 {
		*aggIdx = ai.next
...
func (ai *aggInfo) Step(ctx *C.sqlite3_3_26_context, argv []*C.sqlite3_3_26_value) {
...
func (ai *aggInfo) Done(ctx *C.sqlite3_3_26_context) {
...
func (c *SQLiteConn) RegisterCollation(name string, cmp func(string, string) int) error {
	...
	rv := C.sqlite3_3_26_create_collation(c.db, cname, C.SQLITE_UTF8, handle, (*[0]byte)(unsafe.Pointer(C.compareTrampoline_new)))
	if rv != C.SQLITE_OK {
		return c.lastError()
	}
	return nil
...
func (c *SQLiteConn) RegisterCommitHook(callback func() int) {
	if callback == nil {
		C.sqlite3_3_26_commit_hook(c.db, nil, nil)
	} else {
		C.sqlite3_3_26_commit_hook(c.db, (*[0]byte)(C.commitHookTrampoline_new), newHandle(c, callback))
	}
}
...
func (c *SQLiteConn) RegisterRollbackHook(callback func()) {
	if callback == nil {
		C.sqlite3_3_26_rollback_hook(c.db, nil, nil)
	} else {
		C.sqlite3_3_26_rollback_hook(c.db, (*[0]byte)(C.rollbackHookTrampoline_new), newHandle(c, callback))
	}
}
...
func (c *SQLiteConn) RegisterUpdateHook(callback func(int, string, string, int64)) {
	if callback == nil {
		C.sqlite3_3_26_update_hook(c.db, nil, nil)
	} else {
		C.sqlite3_3_26_update_hook(c.db, (*[0]byte)(C.updateHookTrampoline_new), newHandle(c, callback))
	}
}
...
func (c *SQLiteConn) RegisterAuthorizer(callback func(int, string, string, string) int) {
	if callback == nil {
		C.sqlite3_3_26_set_authorizer(c.db, nil, nil)
	} else {
		C.sqlite3_3_26_set_authorizer(c.db, (*[0]byte)(C.authorizerTrampoline_new), newHandle(c, callback))
	}
}
...
func (c *SQLiteConn) RegisterFunc(name string, impl any, pure bool) error {
	...
	rv := sqlite3CreateFunction(c.db, cname, C.int(numArgs), C.int(opts), newHandle(c, &fi), C.callbackTrampoline_new, nil, nil)
	if rv != C.SQLITE_OK {
		return c.lastError()
	}
	return nil
...
func sqlite3CreateFunction(db *C.sqlite3, zFunctionName *C.char, nArg C.int, eTextRep C.int, pApp unsafe.Pointer, xFunc unsafe.Pointer, xStep unsafe.Pointer, xFinal unsafe.Pointer) C.int {
	return C._sqlite3_3_26_create_function(db, zFunctionName, nArg, eTextRep, C.uintptr_t(uintptr(pApp)), (*[0]byte)(xFunc), (*[0]byte)(xStep), (*[0]byte)(xFinal))
}
...
func (c *SQLiteConn) RegisterAggregator(name string, impl any, pure bool) error {
	...
	rv := sqlite3CreateFunction(c.db, cname, C.int(stepNArgs), C.int(opts), newHandle(c, &ai), nil, C.stepTrampoline_new, C.doneTrampoline_new)
	if rv != C.SQLITE_OK {
		return c.lastError()
	}
	return nil
...
func (c *SQLiteConn) AutoCommit() bool {
	c.mu.Lock()
	defer c.mu.Unlock()
	return int(C.sqlite3_3_26_get_autocommit(c.db)) != 0
}
...
func lastError(db *C.sqlite3) error {
	rv := C.sqlite3_3_26_errcode(db) // returns SQLITE_NOMEM if db == nil
	if rv == C.SQLITE_OK {
		return nil
	}
	extrv := C.sqlite3_3_26_extended_errcode(db)    // returns SQLITE_NOMEM if db == nil
	errStr := C.GoString(C.sqlite3_3_26_errmsg(db)) // returns "out of memory" if db == nil
	...
	if rv == C.SQLITE_CANTOPEN || (rv == C.SQLITE_IOERR && extrv != C.SQLITE_IOERR_NOMEM) {
		systemErrno = syscall.Errno(C.sqlite3_3_26_system_errno(db))
	}
...
func (d *SQLiteDriver) Open(dsn string) (driver.Conn, error) {
	if C.sqlite3_3_26_threadsafe() == 0 {
	...
	rv := C._sqlite3_3_26_open_v2(name, &db,
	...
	exec := func(s string) error {
		cs := C.CString(s)
		rv := C.sqlite3_3_26_exec(db, cs, nil, nil, nil)
...
func (c *SQLiteConn) Close() error {
	rv := C.sqlite3_3_26_close_v2(c.db)
	if rv != C.SQLITE_OK {
		return c.lastError()
	}
	deleteHandles(c)
...
func (c *SQLiteConn) prepare(ctx context.Context, query string) (driver.Stmt, error) {
	...
	var s *C.sqlite3_3_26_stmt
	var tail *C.char
	rv := C._sqlite3_3_26_prepare_v2_internal(c.db, pquery, C.int(-1), &s, &tail)
	if rv != C.SQLITE_OK {
...
func (c *SQLiteConn) GetFilename(schemaName string) string {
	...
	return C.GoString(C.sqlite3_3_26_db_filename(c.db, C.CString(schemaName)))
}

// GetLimit returns the current value of a run-time limit.
// See: sqlite3_limit, http://www.sqlite.org/c3ref/limit.html
func (c *SQLiteConn) GetLimit(id int) int {
	return int(C._sqlite3_3_26_limit(c.db, C.int(id), C.int(-1)))
}
...
func (c *SQLiteConn) SetLimit(id int, newVal int) int {
	return int(C._sqlite3_3_26_limit(c.db, C.int(id), C.int(newVal)))
}
...
func (c *SQLiteConn) SetFileControlInt(dbName string, op int, arg int) error {
	...
	cArg := C.int(arg)
	rv := C.sqlite3_3_26_file_control(c.db, cDBName, C.int(op), unsafe.Pointer(&cArg))
	if rv != C.SQLITE_OK {
		return c.lastError()
	}
	return nil
...
func (s *SQLiteStmt) Close() error {
	...
	rv := C.sqlite3_3_26_finalize(s.s)
	s.s = nil
	if rv != C.SQLITE_OK {
...
func (s *SQLiteStmt) NumInput() int {
	return int(C.sqlite3_3_26_bind_parameter_count(s.s))
}

var placeHolder = []byte{0}

func (s *SQLiteStmt) bind(args []driver.NamedValue) error {
	rv := C.sqlite3_3_26_reset(s.s)
	...
	for i, v := range args {
		...
		if v.Name != "" {
			for j := range prefixes {
				...
				bindIndices[i][j] = int(C.sqlite3_3_26_bind_parameter_index(s.s, cname))
	...
	for i, arg := range args {
		for j := range bindIndices[i] {
			...
			case nil:
				rv = C.sqlite3_3_26_bind_null(s.s, n)
			case string:
				if len(v) == 0 {
					rv = C._sqlite3_3_26_bind_text(s.s, n, (*C.char)(unsafe.Pointer(&placeHolder[0])), C.int(0))
				} else {
					b := []byte(v)
					rv = C._sqlite3_3_26_bind_text(s.s, n, (*C.char)(unsafe.Pointer(&b[0])), C.int(len(b)))
				}
			case int64:
				rv = C.sqlite3_3_26_bind_int64(s.s, n, C.sqlite3_3_26_int64(v))
			case bool:
				if v {
					rv = C.sqlite3_3_26_bind_int(s.s, n, 1)
				} else {
					rv = C.sqlite3_3_26_bind_int(s.s, n, 0)
				}
			case float64:
				rv = C.sqlite3_3_26_bind_double(s.s, n, C.double(v))
			case []byte:
				if v == nil {
					rv = C.sqlite3_3_26_bind_null(s.s, n)
				} else {
					...
					rv = C._sqlite3_3_26_bind_blob(s.s, n, unsafe.Pointer(&v[0]), C.int(ln))
				}
			case time.Time:
...
func (s *SQLiteStmt) query(ctx context.Context, args []driver.NamedValue) (driver.Rows, error) {
	...
	rows := &SQLiteRows{
		s:        s,
		nc:       int32(C.sqlite3_3_26_column_count(s.s)),
		cls:      s.cls,
		cols:     nil,
		decltype: nil,
		ctx:      ctx,
...
func (s *SQLiteStmt) exec(ctx context.Context, args []driver.NamedValue) (driver.Result, error) {
	...
	case <-ctx.Done():
		...
		default:
			...
			C.sqlite3_3_26_interrupt(s.c.db)
...
func (s *SQLiteStmt) execSync(args []driver.NamedValue) (driver.Result, error) {
	if err := s.bind(args); err != nil {
		C.sqlite3_3_26_reset(s.s)
		C.sqlite3_3_26_clear_bindings(s.s)
		return nil, err
	}

	var rowid, changes C.longlong
	rv := C._sqlite3_3_26_step_row_internal(s.s, &rowid, &changes)
	if rv != C.SQLITE_ROW && rv != C.SQLITE_OK && rv != C.SQLITE_DONE {
		err := s.c.lastError()
		C.sqlite3_3_26_reset(s.s)
		C.sqlite3_3_26_clear_bindings(s.s)
...
func (s *SQLiteStmt) Readonly() bool {
	return C.sqlite3_3_26_stmt_readonly(s.s) == 1
}
...
func (rc *SQLiteRows) Columns() []string {
	...
	if rc.s.s != nil && int(rc.nc) != len(rc.cols) {
		...
		for i := 0; i < int(rc.nc); i++ {
			rc.cols[i] = C.GoString(C.sqlite3_3_26_column_name(rc.s.s, C.int(i)))
		}
	}
	return rc.cols
}
...
func (rc *SQLiteRows) declTypes() []string {
	if rc.s.s != nil && rc.decltype == nil {
		...
		for i := 0; i < int(rc.nc); i++ {
			rc.decltype[i] = strings.ToLower(C.GoString(C.sqlite3_3_26_column_decltype(rc.s.s, C.int(i))))
		}
	}
	return rc.decltype
}
...
func (rc *SQLiteRows) Next(dest []driver.Value) error {
	...
	case <-rc.ctx.Done():
		...
		default:
			...
			C.sqlite3_3_26_interrupt(rc.s.c.db)
...
func (rc *SQLiteRows) nextSyncLocked(dest []driver.Value) error {
	rv := C._sqlite3_3_26_step_internal(rc.s.s)
	if rv == C.SQLITE_DONE {
		return io.EOF
	}
	if rv != C.SQLITE_ROW {
		rv = C.sqlite3_3_26_reset(rc.s.s)
		if rv != C.SQLITE_OK {
	...
	for i := range dest {
		switch C.sqlite3_3_26_column_type(rc.s.s, C.int(i)) {
		case C.SQLITE_INTEGER:
			val := int64(C.sqlite3_3_26_column_int64(rc.s.s, C.int(i)))
		...
		case C.SQLITE_FLOAT:
			dest[i] = float64(C.sqlite3_3_26_column_double(rc.s.s, C.int(i)))
		case C.SQLITE_BLOB:
			p := C.sqlite3_3_26_column_blob(rc.s.s, C.int(i))
			if p == nil {
				dest[i] = []byte{}
				continue
			}
			n := C.sqlite3_3_26_column_bytes(rc.s.s, C.int(i))
		...
		case C.SQLITE_TEXT:
			...
			n := int(C.sqlite3_3_26_column_bytes(rc.s.s, C.int(i)))
			s := C.GoStringN((*C.char)(unsafe.Pointer(C.sqlite3_3_26_column_text(rc.s.s, C.int(i)))), C.int(n))
