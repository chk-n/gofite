...
func testBackup(t *testing.T, testRowCount int, usePerPageSteps bool) {
	...
	var driverName = fmt.Sprintf("sqlite3_3_26_testBackup_%v_%v_%v", testRowCount, usePerPageSteps, time.Now().UnixNano())
...
func TestBackupError(t *testing.T) {
	const driverName = "sqlite3_3_26_TestBackupError"
